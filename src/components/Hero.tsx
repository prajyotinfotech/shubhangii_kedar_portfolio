...
import slidePrimary from '../assets/3.webp'
import slideStudio from '../assets/6.webp'
import slideLive from '../assets/backofthelatestR.webp'
import slidePrimaryMobile from '../assets/mobile1stslide.webp'
